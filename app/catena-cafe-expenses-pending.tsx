...
export default function CatenaCafeExpensesPending() {
  ...
  async function fetchExpenses() {
    ...
    try {
      const q = query(
        collection(db, 'catenacafeexpense'),
  ...
  async function handleDownloadReport() {
    ...
    const html = `
      <h2>Catena Cafe Pending Expenses Report</h2>
  ...
  async function handleUpdateStatus() {
    ...
    setLoading(true);
    try {
      await updateDoc(doc(db, 'catenacafeexpense', selected.id), { status: editStatus });
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <MaterialCommunityIcons name="bank" size={28} color={DARK_GREEN} />
          ...
          <Card.Content>
            <View style={styles.filterRow}>
              <View style={styles.pickerContainer}>
                <MaterialCommunityIcons name="filter-variant" size={20} color={PRIMARY_GREEN} />
                <Picker
            ...
            <View style={styles.dateRow}>
              ...
              >
                <MaterialCommunityIcons name="calendar-start" size={20} color={PRIMARY_GREEN} />
              ...
              >
                <MaterialCommunityIcons name="calendar-end" size={20} color={PRIMARY_GREEN} />
        ...
        <Card style={styles.summaryCard}>
          <Card.Content>
            <View style={styles.summaryRow}>
              ...
              <View style={styles.summaryItem}>
                <MaterialCommunityIcons name="format-list-numbered" size={24} color={DARK_GREEN} />
        ...
        {expenses.length === 0 ? (
          <Card style={styles.emptyCard}>
            <Card.Content style={styles.emptyContent}>
              <MaterialCommunityIcons name="bank-remove" size={64} color={PRIMARY_GREEN} />
          ...
          <Dialog.Content>
            {selected && (
              <View style={styles.dialogContent}>
                <View style={styles.dialogRow}>
                  <MaterialCommunityIcons name="account" size={20} color={PRIMARY_GREEN} />
                  <Text style={styles.dialogLabel}>Created By:</Text>
                  <Text style={styles.dialogValue}>{selected.createdBy || '-'}</Text>
                </View>
                <View style={styles.dialogRow}>
                  <MaterialCommunityIcons name="currency-inr" size={20} color={PRIMARY_GREEN} />
                  <Text style={styles.dialogLabel}>Amount:</Text>
                  <Text style={styles.dialogValue}>₹{(selected.cash || 0).toLocaleString()}</Text>
                </View>
                <View style={styles.dialogRow}>
                  <MaterialCommunityIcons name={getTypeIcon(selected.type)} size={20} color={PRIMARY_GREEN} />
            ...
            <View style={styles.statusSelector}>
              ...
              <RadioButton.Group onValueChange={v => setEditStatus(v as 'pending' | 'done')} value={editStatus}>
                <RadioButton.Item label="Pending" value="pending" color={PRIMARY_GREEN} />
                <RadioButton.Item label="Completed" value="done" color={PRIMARY_GREEN} />
              </RadioButton.Group>
            </View>
          </Dialog.Content>
          <Dialog.Actions>
            <Button onPress={() => setModalVisible(false)} textColor={PRIMARY_GREEN}>Cancel</Button>
            <Button onPress={handleUpdateStatus} loading={loading} textColor={PRIMARY_GREEN}>Save</Button>
          </Dialog.Actions>
        </Dialog>
      </Portal>
    </View>
