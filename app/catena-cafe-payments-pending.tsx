  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <MaterialCommunityIcons name="cash-multiple" size={28} color={DARK_GREEN} />
          ...
          <Card.Content>
            <View style={styles.summaryRow}>
              <View style={styles.summaryItem}>
                <MaterialCommunityIcons name="cash" size={24} color={DARK_GREEN} />
        ...
        {payments.length === 0 ? (
          <Card style={styles.emptyCard}>
            <Card.Content style={styles.emptyContent}>
              <MaterialCommunityIcons name="cash-remove" size={64} color={PRIMARY_GREEN} />
      ...
      <Portal>
        <Dialog visible={modalVisible} onDismiss={() => setModalVisible(false)}>
          ...
          <Dialog.Actions>
            ...
            <Button onPress={handleSave} loading={loading} textColor={PRIMARY_GREEN}>Save</Button>
          </Dialog.Actions>
        </Dialog>
      </Portal>
    </View>
