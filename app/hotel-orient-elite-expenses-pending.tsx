...
export default function HotelOrientEliteExpensesPending() {
  ...
  async function handleDownloadReport() {
    ...
    const html = `
      <h2>Hotel Orient Elite Pending Expenses Report</h2>
  ...
  async function handleUpdateStatus() {
    ...
    setLoading(true);
    try {
      await updateDoc(doc(db, 'expenses', selected.id), { status: editStatus });
  ...
  return (
    <View style={styles.container}>
      <View style={styles.headerContainer}>
        <MaterialCommunityIcons name="bank" size={28} color={DARK_GOLD} />
          ...
          <Card.Content>
            <View style={styles.summaryRow}>
              <View style={styles.summaryItem}>
                <MaterialCommunityIcons name="currency-inr" size={24} color={DARK_GOLD} />
        ...
        {expenses.length === 0 ? (
          <Card style={styles.emptyCard}>
            <Card.Content style={styles.emptyContent}>
              <MaterialCommunityIcons name="bank-remove" size={64} color={PRIMARY_COLOR} />
      ...
      <Portal>
        <Dialog visible={modalVisible} onDismiss={() => setModalVisible(false)}>
          ...
          <Dialog.Actions>
            ...
            <Button onPress={handleUpdateStatus} loading={loading} textColor={PRIMARY_COLOR}>Save</Button>
          </Dialog.Actions>
        </Dialog>
      </Portal>
    </View>
