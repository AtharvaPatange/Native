...
export default function HotelOrientEliteMaintenancePayments() {
  ...
  async function handleSave() {
    ...
    setLoading(true);
    try {
      await updateDoc(doc(db, 'vendorPayments', selected.id), { status });
        ...
        <Card style={styles.actionCard}>
          <Card.Content>
            <TouchableOpacity 
              ...
              onPress={() => router.push('/hotel-orient-elite-all-vendor-payments')}
            >
