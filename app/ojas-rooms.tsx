...
export default function OjasRooms() {
  ...
  // Fetch all rooms
  useEffect(() => {
    const unsub = onSnapshot(collection(db, 'ojasRooms'), snap => {
  ...
  const handleAddGuest = async () => {
    ...
    await setDoc(doc(db, 'ojasRooms', selectedRoom!), {
      status: 'active',
      guest: {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.header}>Ojas Rooms</Text>
          ...
          <View style={styles.modalContent}>
            ...
            {showAddGuest && (
              <>
                ...
                <TextInput label="Payment Amount" value={amount} onChangeText={setAmount} style={styles.input} keyboardType="numeric" />
